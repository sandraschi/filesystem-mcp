...
$testPort = 11999
$oldPort = $env:FILESYSTEM_PORT; $oldHost = $env:FILESYSTEM_HOST
$env:FILESYSTEM_PORT = "$testPort"; $env:FILESYSTEM_HOST = "127.0.0.1"
$testProc = Start-Process -FilePath $src -NoNewWindow -PassThru -RedirectStandardError "$Root\dist\pyi-crash.log"
Start-Sleep -Seconds 5
$env:FILESYSTEM_PORT = $oldPort; $env:FILESYSTEM_HOST = $oldHost
...
$strayExe = "$PSScriptRoot\target\release\filesystem-mcp-backend.exe"

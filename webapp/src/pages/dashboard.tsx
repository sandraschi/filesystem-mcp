import { Activity, Cpu, GitBranch, HardDrive } from "lucide-react";
    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        {[
          ...
          <div
            key={i}
            className="rounded-xl border border-border bg-card p-6 shadow-sm transition-all hover:shadow-md hover:bg-card/80"
          >
